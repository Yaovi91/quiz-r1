...
export function resetStatsAndProgression() {
  try {
    ...
    // Lot 3b — Nouvelles clés à nettoyer
    localStorage.removeItem("quizr1.v1.appState");
    localStorage.removeItem("quizr1.v1.unlockedBadges");
    localStorage.removeItem("quizr1.v1.sprintRecords");
    localStorage.removeItem("quizr1.v1.sprintCounters");
    return true;
  } catch (e) {

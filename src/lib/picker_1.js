...
// v3 — support multi-référentiels (R1, EN12845, R5, …) avec ratios pondérés.
...
export function pickQuestion(pool, state, opts = {}) {
  ...
  // 2. Pondération édition (80% 2024/2025/2026 / 20% antérieures) — sauf modes ciblés
  if (mode === "libre" || mode === "daily") {
    const wantOld = rand() < 0.2;
    const isRecent = (q) => q.edition === "2024" || q.edition === "2025" || q.edition === "2026";
